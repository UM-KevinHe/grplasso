...
RcppExport SEXP _grplasso_FirthGamma(SEXP Y_barSEXP, SEXP n_provSEXP, SEXP gamma_initSEXP, SEXP max_iterSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type Y_bar(Y_barSEXP);
    Rcpp::traits::input_parameter< arma::vec& >::type n_prov(n_provSEXP);
    Rcpp::traits::input_parameter< arma::vec& >::type gamma_init(gamma_initSEXP);
    Rcpp::traits::input_parameter< int >::type max_iter(max_iterSEXP);
    Rcpp::traits::input_parameter< double >::type tol(tolSEXP);
    rcpp_result_gen = Rcpp::wrap(FirthGamma(Y_bar, n_prov, gamma_init, max_iter, tol));
    return rcpp_result_gen;
END_RCPP
}
// Deviance
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_grplasso_grp_lasso", (DL_FUNC) &_grplasso_grp_lasso, 28},
    ...
    {"_grplasso_FirthGamma", (DL_FUNC) &_grplasso_FirthGamma, 5},
