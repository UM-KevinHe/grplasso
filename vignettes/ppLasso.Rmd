...
The primary output of the `pp.DiscSurv()` function consists of three sets of coefficients, which correspond to the covariate estimates, log-transformed baseline hazard for different time points, and provider effects. We set the first provider as reference group to avoid the multicollinearity issues.
