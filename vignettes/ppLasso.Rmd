...
The primary output of the `pp.DiscSurv()` function consists of three sets of coefficients, which correspond to the covariate estimates, log-transformed baseline hazard for different time points, and provider effects (with the first provider serving as the reference group).
