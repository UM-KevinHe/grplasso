...
RcppExport SEXP _TmpGrlasso_SerBIN(SEXP YSEXP, SEXP ZSEXP, SEXP n_provSEXP, SEXP gammaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
...
// Z_max_grLasso
double Z_max_grLasso(mat& x, vec& y, vec& K, vec& m);
RcppExport SEXP _TmpGrlasso_Z_max_grLasso(SEXP xSEXP, SEXP ySEXP, SEXP KSEXP, SEXP mSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(Z_max_grLasso(x, y, K, m));
    return rcpp_result_gen;
END_RCPP
}
// Deviance
double Deviance(vec& Y, vec& p);
RcppExport SEXP _TmpGrlasso_Deviance(SEXP YSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< vec& >::type Y(YSEXP);
...
RcppExport SEXP _TmpGrlasso_rcpp_hello_world() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_TmpGrlasso_SerBIN", (DL_FUNC) &_TmpGrlasso_SerBIN, 5},
    {"_TmpGrlasso_Z_max_grLasso", (DL_FUNC) &_TmpGrlasso_Z_max_grLasso, 4},
    {"_TmpGrlasso_Deviance", (DL_FUNC) &_TmpGrlasso_Deviance, 2},
    {"_TmpGrlasso_grp_lasso", (DL_FUNC) &_TmpGrlasso_grp_lasso, 22},
    {"_TmpGrlasso_rcpp_hello_world", (DL_FUNC) &_TmpGrlasso_rcpp_hello_world, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_TmpGrlasso(DllInfo *dll) {
