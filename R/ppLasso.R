...
#' # fitted covariate coefficients, under the lambda sequence the package
...
pp.lasso <- function(data, Y.char, Z.char, prov.char, standardize = TRUE, lambda, nlambda = 100, lambda.min.ratio = 1e-4,
                     ...
                     actSetRemove = FALSE, returnX = FALSE, trace.lambda = FALSE, threads = 1, MM = FALSE, ...){
