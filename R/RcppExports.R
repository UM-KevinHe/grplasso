...
grp_lasso <- function(Y, Z, n_prov, gamma, beta, K0, K1, lambda_seq, lambda_early_stop, stop_dev_ratio, group_multiplier, max_total_iter, max_each_iter, tol, nullDev, backtrack, bound, initial_active_group, nvar_max, group_max, trace_lambda, single_intercept, threads, actSet, actIter, activeGroupNum, actSetRemove, firth) {
    .Call(`_grplasso_grp_lasso`, Y, Z, n_prov, gamma, beta, K0, K1, lambda_seq, lambda_early_stop, stop_dev_ratio, group_multiplier, max_total_iter, max_each_iter, tol, nullDev, backtrack, bound, initial_active_group, nvar_max, group_max, trace_lambda, single_intercept, threads, actSet, actIter, activeGroupNum, actSetRemove, firth)
}
...
FirthGamma <- function(Y_bar, n_prov, gamma_init, max_iter, tol) {
    .Call(`_grplasso_FirthGamma`, Y_bar, n_prov, gamma_init, max_iter, tol)
}
